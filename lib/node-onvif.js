...
* ---------------------------------------------------------------- */
Onvif.prototype.startDiscovery = function(opts, callback) {
	this.startProbe(opts).then((list) => {
		let execCallback = () => {
			let d = list.shift();
			if(d) {
				callback(d);
...
* ---------------------------------------------------------------- */
Onvif.prototype.startProbe = function(opts, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		this._udp.bind(() => {
			this._udp.setMulticastInterface(opts.multicast_interface);
